...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='health.proto',
  package='micro.health.v1',
  syntax='proto3',
  serialized_options=_b('Z\017micro_health_v1'),
  serialized_pb=_b('\n\x0chealth.proto\x12\x0fmicro.health.v1\"%\n\x12HealthCheckRequest\x12\x0f\n\x07service\x18\x01 \x01(\t\"\xaa\x01\n\x13HealthCheckResponse\x12\x42\n\x06status\x18\x01 \x01(\x0e\x32\x32.micro.health.v1.HealthCheckResponse.ServingStatus\"O\n\rServingStatus\x12\x0b\n\x07UNKNOWN\x10\x00\x12\x0b\n\x07SERVING\x10\x01\x12\x0f\n\x0bNOT_SERVING\x10\x02\x12\x13\n\x0fSERVICE_UNKNOWN\x10\x03\x32\xb2\x01\n\x06Health\x12R\n\x05\x43heck\x12#.micro.health.v1.HealthCheckRequest\x1a$.micro.health.v1.HealthCheckResponse\x12T\n\x05Watch\x12#.micro.health.v1.HealthCheckRequest\x1a$.micro.health.v1.HealthCheckResponse0\x01\x42\x11Z\x0fmicro_health_v1b\x06proto3')
)
...
_HEALTHCHECKRESPONSE_SERVINGSTATUS = _descriptor.EnumDescriptor(
  name='ServingStatus',
  full_name='micro.health.v1.HealthCheckResponse.ServingStatus',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_HEALTHCHECKREQUEST = _descriptor.Descriptor(
  ...
  full_name='micro.health.v1.HealthCheckRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='service', full_name='micro.health.v1.HealthCheckRequest.service', index=0,
...
_HEALTHCHECKRESPONSE = _descriptor.Descriptor(
  ...
  full_name='micro.health.v1.HealthCheckResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='micro.health.v1.HealthCheckResponse.status', index=0,
...
HealthCheckRequest = _reflection.GeneratedProtocolMessageType('HealthCheckRequest', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:micro.health.v1.HealthCheckRequest)
  ))
...
HealthCheckResponse = _reflection.GeneratedProtocolMessageType('HealthCheckResponse', (_message.Message,), dict(
  ...
  __module__ = 'health_pb2'
  # @@protoc_insertion_point(class_scope:micro.health.v1.HealthCheckResponse)
  ))
...
_HEALTH = _descriptor.ServiceDescriptor(
  name='Health',
  full_name='micro.health.v1.Health',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='Check',
    full_name='micro.health.v1.Health.Check',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    name='Watch',
    full_name='micro.health.v1.Health.Watch',
    index=1,
    containing_service=None,
    input_type=_HEALTHCHECKREQUEST,
    output_type=_HEALTHCHECKRESPONSE,
